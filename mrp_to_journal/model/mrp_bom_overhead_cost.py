...
class MrpBomOverheadCost(models.Model):
    ...
    total_cost = fields.Float(compute='onchange_overhead_planned_qty', digits='Product Unit of Measure', string="Total Planned Cost")
    total_actual_cost = fields.Float(compute='onchange_overhead_planned_qty', digits='Product Unit of Measure', string="Total Actual Cost")
