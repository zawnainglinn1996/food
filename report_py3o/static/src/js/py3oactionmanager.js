...
console.log(CTX_KEY_REGEX,'PY PY PYP Y PY[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[')
...
//    }
    ...
    function _getPy3oReportURL(action){
        var py3oURL = "/report/py3o/" + action.report_name;
    ...
    async function _triggerDownload(action, options, type) {
        if(type === 'py3o'){
            var url = _getPy3oReportURL(action);
        }
        else{
            var url = _getReportUrl(action, type);
        }
    ...
    async function _executeReportAction(action, options) {
        if ("report_type" in action && action.report_type === "py3o") {
            return _triggerDownload(action, options, "py3o");
        }
    ...
    async function doAction(actionRequest, options = {}) {
        ...
        console.log(action,'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
        switch (action.type) {
